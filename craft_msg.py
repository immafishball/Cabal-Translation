...
def parse_dec_file(file_path):
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        for line in file:
            line = line.strip()
            if line.startswith('<craft_category_msg>'):
                current_section = 'craft_category_msg'
                data[current_section] = {}
            elif line.startswith('<craft_grade_msg>'):
                current_section = 'craft_grade_msg'
                data[current_section] = {}
            elif line.startswith('<craft_mainoption_msg>'):
                current_section = 'craft_mainoption_msg'
                data[current_section] = {}
            elif line.startswith('<request_name_msg>'):
                current_section = 'request_name_msg'
                data[current_section] = {}
            elif line.startswith('</craft_category_msg>') or line.startswith('</craft_grade_msg>') or line.startswith('</craft_mainoption_msg>') or line.startswith('</request_name_msg>'):
                current_section = None
                ...
                if match:
                    ...
                    if current_section:
                        data[current_section][msg_id] = cont
    return data
    ...
    for line in lines:
        ...
        if match:
            ...
            if msg_id in translations:
                ...
                line = re.sub(r'cont="[^"]*"', f'cont="{translation}"', line)
            else:
...
def translate_file(input_file, translation_data, output_file, untranslated_file):
    ...
    for line in lines:
        if line.strip().startswith('<craft_message>'):
            ...
            section_lines = []
            section_opened = False
        elif line.strip().startswith('<craft_category_msg>'):
            ...
            section_lines = []
            section_opened = False
        elif line.strip().startswith('<craft_grade_msg>'):
            if current_section and section_lines:
                translated_lines.extend(translate_section_lines(section_lines, translation_data[current_section], current_section, untranslated_lines))
                translated_lines.append('</' + current_section + '>\n')
            if not section_opened:
            ...
            section_lines = []
            section_opened = False
        elif line.strip().startswith('<craft_mainoption_msg>'):
            if current_section and section_lines:
                translated_lines.extend(translate_section_lines(section_lines, translation_data[current_section], current_section, untranslated_lines))
                translated_lines.append('</' + current_section + '>\n')
            if not section_opened:
            ...
            section_lines = []
            section_opened = False
        elif line.strip().startswith('<request_name_msg>'):
            if current_section and section_lines:
                translated_lines.extend(translate_section_lines(section_lines, translation_data[current_section], current_section, untranslated_lines))
                translated_lines.append('</' + current_section + '>\n')
            if not section_opened:
            ...
            section_lines = []
            section_opened = False
        elif line.strip().startswith('</craft_message>'):
            section_lines.append(line)
            translated_lines.extend(translate_section_lines(section_lines, translation_data.get(current_section, {}), current_section, untranslated_lines))
            current_section = None
            section_lines = []
